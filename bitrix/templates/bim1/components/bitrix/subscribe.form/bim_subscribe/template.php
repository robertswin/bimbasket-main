...
?>
	...
	<?endforeach;?>
		...
		<table border="0" cellspacing="0" cellpadding="2" align="center">
			<tr>
				<td><input type="text" name="sf_EMAIL" class="inp-subscribe" size="20" value="<?=$arResult["EMAIL"]?>" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="Ваш Email"/></td>
			</tr>
			<tr>
				<td align="right"><input type="submit" name="OK" class="btn-subscribe" value="<?=GetMessage("subscr_form_button")?>" /></td>
			</tr>
		</table>
	</form>
<?

		...
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			...
			<div class="col-sm-9 bx-soa">
				...
				<div id="bx-soa-orderSave" class="hidden-xs">
					<a href="javascript:void(0)" style="margin: 10px 0" class="pull-right btn btn-default btn-lg" onclick="ga('send', 'event', 'Выбор оплаты и доставки', 'Оформить заказ','Выбор оплаты и доставки офромить')">
						<?=$arParams['MESS_ORDER']?>
					</a>
				</div>

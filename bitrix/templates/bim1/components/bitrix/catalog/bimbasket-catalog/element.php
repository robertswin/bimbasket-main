...
?>
<div class="row">
<!-- ADMINTAD PIXEL PROD LIST -->

<!-- 	admitad-pixel-text -->
<script type="text/javascript">
//срок действия куки в секундах
var adcookiedate = '600';
//домен на который распространяется кука, в данном случае домен и все его поддомены
var addomain = '.bimbasket.ru'
//дата окончания действия куки
var date = new Date(new Date().getTime() + adcookiedate * 1000);
//присвоение значения куке
var cookie_val = '<?echo $_REQUEST["admitad_uid"];?>';
//присвоение куки
document.cookie = 'admitad_cookie=' + cookie_val + '; path=/; domain=' + addomain + ';expires=' + date.toUTCString();
</script>

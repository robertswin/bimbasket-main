...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	$productTitle = (
		isset($arItem['PROPERTIES']['pnyatnoe_nazvanie_for_m']['~VALUE'])&& $arItem['PROPERTIES']['pnyatnoe_nazvanie_for_m']['~VALUE'] != ''
		? $arItem['PROPERTIES']['pnyatnoe_nazvanie_for_m']['~VALUE']
		: $arItem['NAME']
	...
	{
	?>
			<div id="<? echo $arItemIDs['STICKER_ID']; ?>" class="label-new average right top" title="<? echo $arItem['LABEL_VALUE']; ?>"><? echo $arItem['LABEL_VALUE']; ?></div>
	<?
	}
	?>
	...
	if ($arItem["PROPERTIES"]['LABEL_NEW']['VALUE_XML_ID'] == 'N' ||
	$arItem["PROPERTIES"]['LABEL_HIT']['VALUE_XML_ID'] == 'N' ||
	$arItem["PROPERTIES"]['LABEL_SKIDKA']['VALUE_XML_ID'] == 'N' || 
	$arItem["PROPERTIES"]['LABEL_0_3']['VALUE_XML_ID'] == 'N' || 
	$arItem["PROPERTIES"]['LABEL_3_5']['VALUE_XML_ID'] == 'N')
	{
		
	} elseif ($arItem["PROPERTIES"]['LABEL_NEW']['VALUE_XML_ID'] == 'Y'){
	echo "<div class='label-new'>New</div>";
	} elseif ($arItem["PROPERTIES"]['LABEL_HIT']['VALUE_XML_ID'] == 'Y'){
	echo "<div class='label-hit'>Хит!</div>";
	}  elseif ($arItem["PROPERTIES"]['LABEL_SKIDKA']['VALUE_XML_ID'] == 'Y'){
	echo "<div class='label-skidka'>-20%</div>";
	}   elseif ($arItem["PROPERTIES"]['LABEL_0_3']['VALUE_XML_ID'] == 'Y'){
	echo "<div class='label-0-3-year'>0-3 года</div>";
	}   elseif ($arItem["PROPERTIES"]['LABEL_3_5']['VALUE_XML_ID'] == 'Y'){
	echo "<div class='label-3-5-years'>3-5 лет</div>";
	}
	...
	if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS']))
	{
		...
		<div id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>" class="bx_catalog_item_controls_blocktwo">
			<a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bx_bt_button bx_medium " href="javascript:void(0)" rel="nofollow" onclick="ga('send', 'event', 'Страница списка товаров', 'В корзину', 'В корзину список товаров')"><?

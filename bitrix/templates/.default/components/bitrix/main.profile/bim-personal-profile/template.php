...
<table class="data-table profile-table">
	...
	<p><input type="submit" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>" class="p_save">&nbsp;&nbsp;<input type="reset" value="<?=GetMessage('MAIN_RESET');?>" class="p_reset"></p>
</form>
<?
